...
public class MovieRatingsApp {
	...
	/*
	 * This app depends on the classes Movie and MovieCollection, which you have to
	 * write. This main method gives you some sample movies to use to add to your
	 * collection. Feel free to add some of your favorites to this list! Sean
	 * Blessing - May 2019
	 */
