...
public class FutureValueApp {
	...
	private static String printFormattedResults(double monthlyInvestment, double interestRate, int years, double futureValue) {
    ...
    public static void main(String[] args) {
        ...
        while (choice.equalsIgnoreCase("y")) {
            ...
            System.out.println(printFormattedResults(monthlyInvestment, monthlyInterestRate, years, futureValue));
